...
exiftool -api QuickTimeUTC -api largefilesupport=1 -execute "-FileName<CreateDate" -d "IMG_%Y%m%d_%H%M%S%%-c.%%e" -ext jpg -ext png -ext+ hsp $1 -execute "-Directory<CreateDate" -d "$1/IMG/%Y-%m-%d" -ext jpg -ext png -ext+ hsp $1;
